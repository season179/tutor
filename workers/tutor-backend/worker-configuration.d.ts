/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/tutor-backend/wrangler.jsonc workers/tutor-backend/worker-configuration.d.ts` (hash: 5d165362d528ceb6f7ca112439ec23ba)
// Runtime types generated with workerd@1.20260611.1 2026-06-13 nodejs_compat
interface __BaseEnv_Env {
	TUTOR_PHOTOS: R2Bucket;
	TUTOR_DB: D1Database;
	ALLOWED_ORIGINS: "http://localhost:8081,http://localhost:19006,http://127.0.0.1:8081,http://127.0.0.1:19006";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "OPENAI_REALTIME_MODEL" | "OPENAI_REALTIME_VOICE" | "OPENAI_API_KEY" | "CLOUDFLARE_ACCESS_AUD" | "OPENAI_SAFETY_IDENTIFIER_SALT">> {}
}
