/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/tutor-backend/wrangler.jsonc workers/tutor-backend/worker-configuration.d.ts` (hash: 59b45e51a214580ca3ee9810477e2d56)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "OPENAI_REALTIME_MODEL" | "OPENAI_REALTIME_VOICE">> {}
}
