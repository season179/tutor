/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/tutor-backend/wrangler.jsonc workers/tutor-backend/worker-configuration.d.ts` (hash: 6fb74951b363981ec7daa41a3d16d5b9)
